"" vim-iced mappings {{{
  ...
  silent! nmap <buffer> <LocalLeader>eb <Plug>(iced_eval_and_print)
  silent! nmap <buffer> <LocalLeader>er <Plug>(iced_eval_and_replace)
  ...
  silent! nmap <buffer> <LocalLeader>bb <Plug>(iced_stdout_buffer_toggle)
  silent! nmap <buffer> <LocalLeader>bc <Plug>(iced_stdout_buffer_clear)
